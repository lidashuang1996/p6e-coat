...
import club.p6e.coat.auth.web.service.AccountPasswordLoginService;
...
public class AccountPasswordLoginController {
    ...
    private LoginContext.AccountPassword.Request validate(
        ...
        if (result == null) {
            throw GlobalExceptionContext.executeParameterException(
                    this.getClass(),
                    "fun LoginContext.AccountPassword.Request validate(HttpServletRequest httpServletRequest, " +
                            "HttpServletResponse httpServletResponse, LoginContext.AccountPassword.Request request)",
    ...
    public Object def(
        ...
        final LoginContext.AccountPassword.Request r = validate(httpServletRequest, httpServletResponse, request);
        return SpringUtil.getBean(AccountPasswordLoginService.class).execute(httpServletRequest, httpServletResponse, r);
    }
