...
public class BlockingUserRepositoryImpl implements BlockingUserRepository {
     ...
     */
    public BlockingUserRepositoryImpl(UserBuilder builder, JdbcTemplate template, PlatformTransactionManager transactionManager) {
    ...
    private User convertResultSetToUser(ResultSet rs) throws SQLException {
        return this.builder.create(new HashMap<>() {{
