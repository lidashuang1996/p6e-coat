...
import club.p6e.coat.auth.web.cache.QuickResponseCodeLoginCache;
...
public class QuickResponseCodeLoginRedisCache implements QuickResponseCodeLoginCache {
     ...
     */
    public QuickResponseCodeLoginRedisCache(StringRedisTemplate template) {
