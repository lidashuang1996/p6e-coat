 ...
 * @version 1.0
 */
public class WebFluxLocalStorageCacheTokenGenerator implements WebFluxTokenGenerator {

    private final UserTokenCache cache;

    public WebFluxLocalStorageCacheTokenGenerator(UserTokenCache cache) {
        this.cache = cache;
    }
