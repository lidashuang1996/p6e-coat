...
import club.p6e.coat.auth.web.service.AuthenticationLoginService;
...
public class AuthenticationLoginController {
    ...
    private LoginContext.Authentication.Request validate(
        ...
        if (result == null) {
            throw GlobalExceptionContext.executeParameterException(
                    this.getClass(),
                    "fun LoginContext.Authentication.Request validate(HttpServletRequest httpServletRequest, " +
                            "HttpServletResponse httpServletResponse, LoginContext.Authentication.Request request)",
    ...
    public Object def(
        ...
        SpringUtil.getBean(AuthenticationLoginService.class).execute(httpServletRequest, httpServletResponse, r);
