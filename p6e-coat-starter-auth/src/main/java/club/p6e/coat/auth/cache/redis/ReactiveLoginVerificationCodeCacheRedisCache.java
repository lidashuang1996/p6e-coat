 ...
 * @version 1.0
 */
@ConditionalOnMissingBean(ReactiveLoginVerificationCodeCacheRedisCache.class)
@Component("club.p6e.coat.auth.cache.redis.ReactiveLoginVerificationCodeCacheRedisCache")
