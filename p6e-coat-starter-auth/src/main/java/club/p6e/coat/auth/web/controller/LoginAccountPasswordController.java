...
public class LoginAccountPasswordController {
    ...
    private LoginContext.AccountPassword.Request validate(
        ...
        if (result == null) {
            throw GlobalExceptionContext.executeParameterException(
                    this.getClass(),
                    "fun LoginContext.AccountPassword.Request validate(" +
                            "HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, LoginContext.AccountPassword.Request request)",
    ...
    public Object def(
        ...
        return SpringUtil.getBean(LoginAccountPasswordService.class).execute(httpServletRequest, httpServletResponse, r);
    }
