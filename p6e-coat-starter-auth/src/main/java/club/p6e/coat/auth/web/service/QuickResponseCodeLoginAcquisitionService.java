 ...
 * @version 1.0
 */
public interface QuickResponseCodeLoginAcquisitionService {
    ...
    Mono<LoginContext.QuickResponseCodeAcquisition.Dto> execute(
            HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, LoginContext.QuickResponseCodeAcquisition.Request param);
