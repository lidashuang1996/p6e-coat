...
@Component("club.p6e.coat.auth.service.LoginQuickResponseCodeServiceImpl")
...
public class LoginQuickResponseCodeServiceImpl implements LoginQuickResponseCodeService {
     ...
     */
    public LoginQuickResponseCodeServiceImpl(BlockingTokenValidator validator, BlockingLoginQuickResponseCodeCache cache) {
        this.cache = cache;
