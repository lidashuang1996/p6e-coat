...
public class ForgotPasswordVerificationCodeAcquisitionController {
    ...
    private ForgotPasswordContext.VerificationCodeAcquisition.Request validate(
        ...
        if (result == null) {
            throw GlobalExceptionContext.executeParameterException(
                    this.getClass(),
                    "fun ForgotPasswordContext.VerificationCodeAcquisition.Request validate(" +
                            "HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, ForgotPasswordContext.VerificationCodeAcquisition.Request request)",
    ...
    public Object def(
        ...
        final ForgotPasswordContext.VerificationCodeAcquisition.Request r = validate(httpServletRequest, httpServletResponse, request);
        return SpringUtil.getBean(ForgotPasswordVerificationCodeAcquisitionService.class).execute(httpServletRequest, httpServletResponse, r);
    }
