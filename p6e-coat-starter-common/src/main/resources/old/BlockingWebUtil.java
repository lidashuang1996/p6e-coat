package club.p6e.coat.common.controller.old;
...
public class BlockingWebUtil extends BaseController {
    ...
    public static HttpServletRequest getRequest() {
        ...
        throw new RuntimeException(BlockingWebUtil.class + " -> getRequest() HttpServletRequest error!");
    }
    ...
    public static HttpServletResponse getResponse() {
        ...
        throw new RuntimeException(BlockingWebUtil.class + " -> getResponse() HttpServletResponse error!");
    }
