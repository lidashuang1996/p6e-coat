...
/**
 * Launcher Template Default Parser Service
 *
 * @author lidashuang
 * @version 1.0
 */
...
public class LauncherTemplateDefaultParserService implements LauncherTemplateParserService {
     ...
     */
    private static String translate(String content, Function<String, String> vf) {
        return translate(content, vf, IS_VARIABLES_REPLACE_EMPTY_VALUE);
    }
     ...
     * @return Parsing Template Content
     */
    private static String translate(String content, Function<String, String> vf, boolean isVariablesReplaceEmptyValue) {
    ...
    public LauncherTemplateModel execute(LauncherStartingModel starting, TemplateModel template) {
        ...
        model.setLanguage(starting.language());
        ...
        model.setMessageTitle(translate(template.title(), vf));
        model.setMessageContent(translate(template.content(), vf));
        return model;
    }

    /**
     * Simple Template Message Model
     */
