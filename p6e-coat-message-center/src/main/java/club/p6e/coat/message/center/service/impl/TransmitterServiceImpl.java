    ...
    protected synchronized LauncherModel setLauncherData(Integer id) {
        ...
        if (model == null) {
            ...
            if (lm == null) {
                ...
                ExpiredCache.set(LAUNCHER_TYPE, String.valueOf(id), lm, 3600 * 1000L);
                return lm;
            }
        } else {
            return model;
    ...
    protected ConfigModel setConfigData(Integer id) {
        ...
        if (model == null) {
            ...
            if (cm == null) {
                ...
                ExpiredCache.set(CONFIG_TYPE, String.valueOf(id), cm, 3600 * 1000L);
                return cm;
            }
        } else {
            return model;
    ...
    protected TemplateModel setTemplateData(String key, String language) {
        ...
        if (model == null) {
            ...
            if (tm == null) {
                ...
                ExpiredCache.set(TEMPLATE_TYPE, key + "@" + language, tm, 3600 * 1000L);
                return tm;
            }
        } else {
            return model;
