...
/**
 * Telegram Message Config Default Parser Service
 *
 * @author lidashuang
 * @version 1.0
 */
...
public class TelegramMessageConfigDefaultParserService implements TelegramMessageConfigParserService {
     ...
     * Parser Name
     */
    private static final String DEFAULT_PARSER = "TELEGRAM_MESSAGE_CONFIG_DEFAULT_PARSER";
    ...
    /**
     * Simple Telegram Message Config Model
     */
